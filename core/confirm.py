...
class ConfirmGate:
    """Interface-compatible wrapper around the existing confirm module."""

    def request_confirmation(self, action: str, description: str) -> str:
        """Request confirmation for an action. Returns a pending token message."""
        return request(action, action, description, lambda: description)
